    ...
    <>
      ...
      >
        <Loader
          ...
          strokeWidth={2.5}
          className={cn(
            dark ? "text-zinc-700" : white ? "text-white" : "text-zinc-600 dark:text-zinc-200",
          )}
        />
        ...
        <span
          className={cn(
            ...
            dark ? "shimmer-text-dark" : white ? "shimmer-text-white" : "shimmer-text",
          )}
          style={{
        ...
        <ChevronRight
          size={16}
          className={cn(
            dark ? "text-zinc-500" : white ? "text-white" : "text-zinc-400 dark:text-zinc-500",
          )}
        />
      </div>

    ...
    <div className="max-w-4xl mx-auto space-y-12 py-12 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-2">
          <button className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/10 text-white font-medium">
            <UserIcon className="h-4 w-4" />
            Account Information
          </button>
          <button className="flex items-center gap-3 px-4 py-3 rounded-xl text-white/40 hover:text-white transition-colors">
